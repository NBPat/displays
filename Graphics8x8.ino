// GraphicsTest.ino
// constructor for lcm12864 screen
// U8X8_ST7565_NHD_C12864_4W_SW_SPI u8x8(/*ck*/ 12, /*dt*/ 14, /*cs*/ 27, /*dc*/ 16, /*rs*/ 17);   // esp32 wemos */
// U8X8_ST7565_NHD_C12864_4W_SW_SPI u8x8(/*ck*/ 8, /*dt*/ 7, /*cs*/ 6, /*dc*/ 5, /*rs*/ 4);    // constructor for Uno board
// final touch     u8x8.setContrast(63);    // for LCM12864
...
U8X8_ST7565_NHD_C12864_4W_SW_SPI u8x8(/*ck*/ 12, /*dt*/ 14, /*cs*/ 27, /*dc*/ 16, /*rs*/ 17);
...
void setup(void)
{
  ...
  u8x8.begin();
    u8x8.setContrast(63);     // for LCM12864 shield
  //u8x8.setFlipMode(1);
}
